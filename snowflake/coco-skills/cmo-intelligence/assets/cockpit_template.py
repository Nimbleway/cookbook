...
var VIEWS={
 ...
 "D&T":function(){
   ...
   var objs='<div class="card p"><h3>Governed objects</h3><p class="why">Everything is a first-class Snowflake object — versioned, permissioned, auditable.</p><div class="obj"><span class="objc">semantic view <b>SHELF_SV</b></span><span class="objc">agent <b>__AGENT_NAME__</b></span><span class="objc">cockpit <b>COCKPIT</b></span><span class="objc">daily task <b>DAILY_SHELF_TASK</b></span><span class="objc">on-demand <b>REFRESH_SHELF()</b></span></div></div>';
