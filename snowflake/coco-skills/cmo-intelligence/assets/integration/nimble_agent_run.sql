 ...
 * Versioning:  the integration version is the single value in setup.sql's
 *              NIMBLE_INTEGRATION.TOOLS.INTEGRATION_VERSION view — BUMP it there
 *              whenever you change this function, so consumers detect a stale install.
