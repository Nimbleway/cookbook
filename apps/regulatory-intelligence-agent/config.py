...
HOW TO WORK - this is a multi-search task, not a single query:
  ...
  - Start each pass with search_depth="standard" (num_results 8-10) to find candidate
  ...
  - Always use search_depth="standard" for these scoped passes. Never pass
    ...
    allow-list in lite mode and returns unrelated off-domain results, which breaks the
    primary-source requirement above.
